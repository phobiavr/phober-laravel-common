...
CREATE TABLE `authors` (
  ...
  PRIMARY KEY (`id`),
  KEY `authors_authorable_type_authorable_id_index` (`authorable_type`,`authorable_id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=62628 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
